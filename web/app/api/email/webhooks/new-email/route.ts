...
import proverSpec from "../../../../../../contracts/out/LexProofProver.sol/LexProofProver.json";
import verifierSpec from "../../../../../../contracts/out/LexProofVerifier.sol/LexProofVerifier.json";
...
export async function POST(request: Request) {
    ...
    const emailEncoded = Buffer.from(nylasData.data.raw_mime, "base64").toString("utf8");
    ...
    const result = await vlayer.waitForProvingResult({ hash }) as [Proof, string, string, string];
