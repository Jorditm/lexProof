      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-slate-600 max-w-2xl mx-auto">
            Decentralized email verification using vlayer technology. Send authenticated emails with on-chain proof of
            delivery.
          </p>
        </div>
          ...
          <div className="max-w-md mx-auto">
            <Card>
              <CardHeader className="text-center">
                ...
                <CardDescription>Connect your crypto wallet to start sending verified emails</CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                <div className="grid gap-3">
                  <div className="flex items-center gap-3 p-3 bg-slate-50 rounded-lg">
                    <CheckCircle className="h-5 w-5 text-green-600" />
                    <span className="text-sm">Email authenticity verification</span>
                  </div>
                  <div className="flex items-center gap-3 p-3 bg-slate-50 rounded-lg">
                    <CheckCircle className="h-5 w-5 text-green-600" />
        ...
        <div className="text-center mt-16 pt-8 border-t border-slate-200">
          <p className="text-slate-500 text-sm">Built with vlayer • Next.js • shadcn/ui</p>
        </div>
      </div>
    </div>
  )
